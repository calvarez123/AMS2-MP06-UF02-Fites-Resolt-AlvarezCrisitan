...
public class Manager {
    ...
    public static Aeroport addAeroportToCiutat(Ciutat ciutatId, String nomAeroport) {
        Session session = factory.openSession();
        Transaction tx = null;
        ...
        try {
            ...
            result.setNom(nomAeroport);
            result.setCiutat(ciutatId);
            session.save(result); 
            tx.commit();
        } catch (HibernateException e) {
            if (tx!=null) tx.rollback();
    ...
    public static Ruta addRuta(String nom, Aeroport origen, Aeroport desti) {
        ...
        try {
            ...
            novaRuta = new Ruta();
            novaRuta.setNom(nom);
            novaRuta.setOrigen(origen);
            novaRuta.setDesti(desti);

            session.save(novaRuta);
