...
public class Main {
   ...
   public static void main(String[] args) {
      ...
      Aeroport aeroport1 = Manager.addAeroportToCiutat(ciutat1, "Aeroport de Barcelona-El Prat");
      Aeroport aeroport2 = Manager.addAeroportToCiutat(ciutat1, "Aeroport de Girona-Costa Brava");

      // Crear aeroports per a Madrid
      Aeroport aeroport3 = Manager.addAeroportToCiutat(ciutat2, "Aeroport Adolfo Suárez Madrid-Barajas");
      Aeroport aeroport4 = Manager.addAeroportToCiutat(ciutat2, "Aeroport de Torrejón");
